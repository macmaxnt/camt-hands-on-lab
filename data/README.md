...
## Source material and parsed full text

`corpus/` contains the approved bilingual readings, source PDF, and attribution. `parsed/unesco-genai-guidance-pages.jsonl` preserves page-level extraction from the complete 48-page UNESCO guidance. `parsed/unesco-genai-guidance-chunks.jsonl` contains overlapping 180-word chunks with source-page metadata.
