...
const copy = {
  en: {
    eyebrow: "AIAT × CAMT · Lab 2", title: "Security workbench", subtitle: "Blue-team controls protect every answer path.", chat: "RAG chat", knowledge: "Knowledge base", agent: "Agent workspace", warning: "Audit records contain fingerprints and decisions only; they never retain raw prompts or answers.", implemented: "Implemented controls", audit: "Recent security audit", staffOnly: "Enable staff access to view privacy-minimised audit events.", emptyAudit: "No audit events yet.",
  ...
  th: {
    eyebrow: "AIAT × CAMT · Lab 2", title: "พื้นที่ทำงานด้านความปลอดภัย", subtitle: "Blue-team controls ปกป้องทุกเส้นทางคำตอบ", chat: "RAG chat", knowledge: "คลังความรู้", agent: "พื้นที่ทำงานเอเจนต์", warning: "Audit เก็บเฉพาะ fingerprint และการตัดสินใจ ไม่เก็บ prompt หรือคำตอบดิบ", implemented: "controls ที่สร้างแล้ว", audit: "security audit ล่าสุด", staffOnly: "เปิดใช้ staff access เพื่อดู audit ที่ลดข้อมูลส่วนบุคคล", emptyAudit: "ยังไม่มี audit event",
